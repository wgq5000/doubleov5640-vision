...
HD_PWD='D:/XME0715/SDK_Demo/21_double_ov5640_hdmi/double_ov5640/double_ov5640.runs/design_1_util_vector_logic_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_util_vector_logic_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_util_vector_logic_1_0.tcl
